...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[700px] lg:min-h-screen bg-transparent overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-0">
